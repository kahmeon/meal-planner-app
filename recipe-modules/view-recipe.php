...
<div class="container py-5">
  ...
  <div class="d-flex justify-content-between print-hidden">
    <a href="recipe-management.php" class="btn btn-secondary">← Back</a>
    <div>
      <a href="edit-recipe.php?id=<?= $recipe_id ?>" class="btn btn-outline-success me-2">✏️ Edit</a>
      <button onclick="window.print()" class="btn btn-outline-primary">🖨️ Print / PDF</button>
    </div>
  </div>
</div>
